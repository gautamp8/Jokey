 ...
 * on 2016-11-05 at 17:40:13 UTC 
 * Modify at your own risk.
 */

package com.brainbreaker.jokey.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.brainbreaker.jokey.backend.myApi.model.MyBean}
   * @return the request
   */
  public SetJoke setJoke(com.brainbreaker.jokey.backend.myApi.model.MyBean content) throws java.io.IOException {
    SetJoke result = new SetJoke(content);
    initialize(result);
    return result;
  }

  public class SetJoke extends MyApiRequest<com.brainbreaker.jokey.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SetJoke(com.brainbreaker.jokey.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.brainbreaker.jokey.backend.myApi.model.MyBean.class);
    }
